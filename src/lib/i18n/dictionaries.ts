...
export const dictionaries = {
  zh: {
    ...
    studentManagement: {
      ...
      ping_students_tooltip: '重新整理學生連線狀態',
    },
    studentPoll: {
    ...
    courseware: {
      ...
      my_packages: '我的教材包',
      create_package: '建立教材包',
      package_name_label: '教材包名稱',
      package_name_placeholder: '例如「五年級數學」',
      no_packages_title: '尚無教材包',
      no_packages_description: '點擊「建立教材包」以開始。',
      units: '單元',
      add_unit: '新增單元',
      unit_name_label: '單元名稱',
      unit_name_placeholder: '例如「第一章：分數」',
      activities: '活動',
      add_activity: '新增活動',
      edit_activity: '編輯活動',
      delete_package: '刪除教材包',
      delete_package_confirm_title: '確定要刪除教材包嗎？',
      delete_package_confirm_description: '這將永久刪除「{name}」及其所有單元和活動。此操作無法復原。',
      delete_unit: '刪除單元',
      delete_unit_confirm_title: '確定要刪除單元嗎？',
      delete_unit_confirm_description: '這將永久刪除「{name}」及其所有活動。',
      delete_activity: '刪除活動',
      delete_activity_confirm_title: '確定要刪除此活動嗎？',
      delete_activity_confirm_description: '此操作無法復原。',
      toast_package_created: '教材包已建立',
      toast_package_updated: '教材包已更新',
      toast_package_deleted: '教材包已刪除',
      toast_unit_created: '單元已新增',
      toast_unit_updated: '單元已更新',
      toast_unit_deleted: '單元已刪除',
      toast_activity_saved: '活動已儲存',
      toast_activity_deleted: '活動已刪除',
      activity_editor_title_add: '新增活動',
      activity_editor_title_edit: '編輯活動',
      use_courseware: '使用教材',
      use_courseware_description: '從您預先建立的教材包中選擇一個問題來發送。',
      select_package: '選擇教材包',
      select_unit: '選擇單元',
      no_activities_in_unit: '此單元中沒有活動。',
      send_question: '發送問題',
    },
  },
  en: {
    ...
    studentManagement: {
      ...
      ping_students_tooltip: 'Ping students to refresh their connection status',
    },
    studentPoll: {
    ...
    courseware: {
      ...
      package_name_placeholder: 'e.g., "Grade 5 Math"',
      no_packages_title: 'No Courseware Packages Yet',
      no_packages_description: 'Click "Create Package" to get started.',
      units: 'Units',
      add_unit: 'Add Unit',
      unit_name_label: 'Unit Name',
      unit_name_placeholder: 'e.g., "Chapter 1: Fractions"',
      activities: 'Activities',
      add_activity: 'Add Activity',
      edit_activity: 'Edit Activity',
      delete_package: 'Delete Package',
      delete_package_confirm_title: 'Are you sure you want to delete this package?',
      delete_package_confirm_description: 'This will permanently delete "{name}" and all of its units and activities. This action cannot be undone.',
      delete_unit: 'Delete Unit',
      delete_unit_confirm_title: 'Are you sure you want to delete this unit?',
      delete_unit_confirm_description: 'This will permanently delete "{name}" and all of its activities.',
      ...
      toast_package_created: 'Courseware package created.',
      toast_package_updated: 'Courseware package updated.',
      toast_package_deleted: 'Courseware package deleted.',
      toast_unit_created: 'Unit added.',
      toast_unit_updated: 'Unit updated.',
      toast_unit_deleted: 'Unit deleted.',
      ...
      use_courseware_description: 'Select a pre-made question from your courseware packages to send.',
      select_package: 'Select a package',
      select_unit: 'Select a unit',
      no_activities_in_unit: 'There are no activities in this unit.',
