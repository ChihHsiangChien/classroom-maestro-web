...
export const dictionaries = {
  zh: {
    ...
    admin: {
      ...
      table_header_actions: '操作',
      you_label: '您',
      delete_confirm_title: '確定要刪除 {name}？',
      delete_confirm_description: '此操作分為兩步驟，且不可復原。請謹慎操作。',
      delete_step1_title: '步驟 1：刪除所有資料',
      delete_step1_description: '這將永久刪除此教師所有的班級、學生名單和活動紀錄。這是刪除帳號前的必要步驟。',
      delete_data_button: '永久刪除資料',
      delete_step2_title: '步驟 2：刪除使用者帳號',
      delete_step2_description: '資料清除後，請到 Firebase 後台手動刪除此使用者的登入帳號。',
      delete_user_account_button: '前往 Firebase 後台',
    ...
    courseware: {
      title: '教材',
      description: '管理您的可重複使用的教材與活動。',
      my_packages: '我的教材',
      create_package: '建立教材',
      edit_package: '編輯教材',
      package_name_label: '教材名稱',
      package_name_placeholder: '例如「A1-1細胞」',
      ...
      edit_activity: '編輯活動',
      delete_package: '刪除教材',
      delete_package_confirm_title: '確定要刪除教材嗎？',
      ...
      use_courseware: '使用教材',
      use_courseware_description: '從您預先建立的教材中選擇一個問題來發送。',
      select_package: '選擇教材',
    ...
    ai_usage: {
      title: 'AI 用量儀表板',
      description: '查看平台上 AI 功能的使用情況。',
      usage_by_feature_chart_title: '各功能使用量',
      usage_over_time_chart_title: '每日使用趨勢',
      raw_logs_table_title: '詳細使用日誌',
      table_header_feature: '功能',
      table_header_user: '使用者',
      table_header_timestamp: '時間戳',
      feature_name_generatePoll: '生成投票',
      feature_name_generateImage: '生成圖片',
      feature_name_analyzeShortAnswers: '分析簡答',
      feature_name_generateQuestionsFromText: '從文本生成問題',
      no_data: '尚無資料',
    }
  },
  en: {
    ...
    firebase: {
      ...
      auth_domain_error_description_p1: "To use Google Sign-In, Firebase requires you to explicitly authorize the domain your app is running on.",
      auth_domain_error_description_p2: "Your app's domain is:",
      ...
      auth_anon_error_title: 'Anonymous Sign-In Disabled',
      auth_anon_error_description: 'This app uses anonymous sign-in to allow students to join classrooms securely. This feature is currently disabled in your Firebase project.',
      auth_anon_error_instructions: "To fix this, please enable the 'Anonymous' sign-in provider in your Firebase Authentication settings.",
      auth_anon_error_button: 'Go to Firebase Sign-In Settings',
    ...
    dashboard: {
      ...
      toast_class_created_title: 'Class created!',
      toast_class_created_description: 'Next step: Add students to your class.',
      ...
      actions_menu_tooltip: 'More actions',
      delete_history_button: 'Delete History',
      download_history_button: 'Download History',
      delete_history_confirm_title: 'Delete all activity history?',
      delete_history_confirm_description: "This will permanently delete all student submissions for '{name}'. This action cannot be undone.",
      toast_history_deleted: 'Activity history deleted.',
      toast_history_no_data_to_delete: 'No activity history to delete.',
      toast_history_download_start: 'Preparing download...',
      toast_history_download_no_data: 'No activity history found to download.',
      toast_history_download_error: 'Failed to download history.',
      download_history_dialog_title: 'Download Activity History',
      download_history_dialog_description: 'Choose the format for your download.',
      download_format_json_button: 'JSON (All Data)',
      download_format_json_description: 'A single file containing all submission data. Best for developers or re-importing.',
      download_format_csv_zip_button: 'CSV & Images (ZIP)',
      download_format_csv_zip_description: 'A ZIP file with text answers in a CSV file and all drawings as separate image files.',
      toast_history_preparing_zip: 'Preparing your ZIP file, please wait...',
      classes: 'Classes',
    },
    teacherLoginForm: {
    ...
    classroomPage: {
      ...
      snatch_countdown: 'Get ready to race...',
      snatch_go: 'Go!',
      snatch_you_won: 'You won!',
    ...
    teacherDashboard: {
      ...
      session_history_title: 'Session Activity History',
      session_history_description: 'Review and reuse questions from this session, or save the entire set as new courseware.',
      reuse_question_button: 'Reuse',
      save_as_courseware_button: 'Save as New Courseware',
      save_courseware_dialog_title: 'Save Session as Courseware',
      save_courseware_dialog_description: 'This will create a new courseware package containing all activities from this session.',
      activity_in_progress_title: 'Activity in Progress',
      activity_in_progress_description: 'Please end the current activity before starting a new one.',
    },
    createQuestionForm: {
      ...
      generate_with_ai_placeholder: "e.g. 'The Photosynthesis'",
      ...
      sa_question_placeholder: 'e.g. What is the cell theory??',
      ...
      answer_empty_error: 'Please set a correct answer.',
    ...
    activePoll: {
      ...
      submission_status_card_title: 'Student Status',
      submission_status_card_description: 'View and sort students by connection and submission status.',
      ...
      sort_by_submission_time: 'Submission Time',
      sort_by_student_name: 'Student Name',
    ...
    lotteryModal: {
      ...
      start_picking_button: 'Start Picking',
      reset_button: 'Reset Lists',
      pick_from_online_label: 'Pick from online students only',
      unique_pick_label: 'Remove from pool after picking (no repeats)',
      unpicked_list_title: 'Unpicked List',
      picked_list_title: 'Picked List',
      no_one_picked_yet: 'No one has been picked yet.',
    ...
    studentManagement: {
      ...
      roster_student_count: '{count} student(s)',
      lottery_button: 'Lottery',
      snatch_button: 'Race',
      snatch_active: 'Race in progress...',
      snatch_countdown: 'Race is about to start!',
      snatch_reset_button: 'Reset Race',
      snatch_winner_is: 'Winner: {name}',
      snatch_finished_title: 'Race Finished',
      snatch_no_winner: 'No winner was declared.',
      table_header_name: 'Name',
      table_header_actions: 'Actions',
      no_students_in_roster: 'There are no students in this roster.',
      no_students_logged_in_message: 'There are no students in the roster.',
      ...
      status_inattentive: 'Inattentive',
      status_offline: 'Offline',
      kick_student_tooltip: 'Log out student',
      toast_student_kicked_title: 'Student Logged Out',
      student_status_card_title: 'Student Status',
      student_status_card_description: 'View and sort students by connection and submission status.',
      submitted_status: 'Submitted',
      waiting_status: 'Waiting...',
      sort_by_label: 'Sort by',
      sort_by_name: 'Name',
      sort_by_status: 'Login Status',
      ...
      ping_students_tooltip: 'Ping students to check attention',
    },
    studentPoll: {
      choose_your_answer: 'Choose your answer:',
      choose_your_answers: 'Choose your answers (multiple selections allowed):',
